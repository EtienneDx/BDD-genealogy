  ...
  return (
    ...
    <form onSubmit={handleSubmit}>
      <div className={styles.inputGroup}>
        <input type="text" id="name-input" className={styles.input} placeholder="Name" value={name} onChange={event => setName(event.target.value)} />
        <input type="text" id="surname-input" className={styles.input} placeholder="Surname" value={surname} onChange={event => setSurname(event.target.value)} />
        <input type="number" id="generations-input" className={styles.input} placeholder="Generations" value={generations} onChange={event => setGenerations(event.target.value)} />
        <button type="submit" id="submit-btn" className={styles.button}>Submit</button>
      </div>
      <div className={styles.treeType}>
        <label>
          <input type="radio" name="tree-type" value="ascendant" checked={treeType === 'ascendant'} onChange={event => setTreeType(event.target.value)} />
          <span className={styles.radioText}>Ascendant Tree</span>
        </label>
        <label>
          <input type="radio" name="tree-type" value="descendant" checked={treeType === 'descendant'} onChange={event => setTreeType(event.target.value)} />
