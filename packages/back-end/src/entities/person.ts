...
export type PersonFather = { person: Person; father: Father; otherPerson: Person };
export type PersonMother = { person: Person; mother: Mother; otherPerson: Person };
export type PersonPartner = { person: Person; partners: Partner[]; otherPersons: Person[] };