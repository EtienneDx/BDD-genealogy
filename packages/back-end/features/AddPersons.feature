Feature: Add persons
  ...
  Scenario: Add a person
    When I "post" a "{\"name\": \"John Doe\"}" object to "/person" authenticated as user 0
    Then "John Doe" is saved in the database
    And I should see a 200 status code

  Scenario: Add a partner
    When I "post" a "{\"name\": \"Jimmy Doe\", \"partner\": [{ \"id\" : 0 }] }" object to "/person" authenticated as user 0
  ...
  Scenario: Add a father
    When I "post" a "{ \"name\": \"John Doe\", \"father\": { \"id\": 0 } }" object to "/person" authenticated as user 0
    Then "John Doe" is saved in the database
  ...
  Scenario: Add a mother
    When I "post" a "{ \"name\": \"Jimmy Doe\", \"mother\": { \"id\": 0 } }" object to "/person" authenticated as user 0
    Then "Jimmy Doe" is saved in the database
